	...
	public class UIFrameHelper {
		...
		public static void DrawUIFrame(Graphics graphics,
			...
			if (n != null && s != null && w != null && e != null && ne != null && sw != null && nw != null &&
				...
				graphics.DrawImage(se.ToImage(),
					new PointF(targetImageWidth - ne.Width, targetImageHeight - sw.Height)); // bottom right
