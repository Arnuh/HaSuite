...
namespace HaCreator.CustomControls {
	...
	public class BetterCheckedListBox : CheckedListBox {
		//----------------------------------------------------------
		...
		public new string Text(int index) {
			return (string) dt.Rows[index][DisplayMember];
		}

		public void SetText(int index, string value) {
			dt.Rows[index][DisplayMember] = value;
		}

		public string Value(int index) {
			return (string) dt.Rows[index][ValueMember];
		}

		public void SetValue(int index, string value) {
			dt.Rows[index][ValueMember] = value;
		}
