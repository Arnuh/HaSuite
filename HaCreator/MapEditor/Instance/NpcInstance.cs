...
namespace HaCreator.MapEditor.Instance {
	public class NpcInstance : LifeInstance {
		...
		public NpcInfo NpcInfo => baseInfo;
		...
		public NpcInstance(NpcInfo baseInfo, Board board, int x, int y, int rx0Shift, int rx1Shift, int yShift,
		...
		public override ItemTypes Type => ItemTypes.NPCs;
