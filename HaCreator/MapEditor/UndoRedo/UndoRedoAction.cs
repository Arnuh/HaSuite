	...
	public class UndoRedoAction {
		...
		public void UndoRedo(HashSet<int> layersToRecheck) {
			...
			switch (type) {
				...
				case UndoRedoType.ItemLayerPlatChanged:
					var oldLayerPlat = (Tuple<int, int>) ParamA;
					var newLayerPlat = (Tuple<int, int>) ParamB;
					var li = (IContainsLayerInfo) ParamC;
				...
				case UndoRedoType.LayerTSChanged:
					var ts_old = (string) ParamA;
					var ts_new = (string) ParamB;
					var l = (Layer) ParamC;
					l.ReplaceTS(ts_old);
					break;
				case UndoRedoType.zMChanged:
					var zm_old = (int) ParamA;
					var zm_new = (int) ParamB;
					var target = (IContainsLayerInfo) ParamC;
		...
		public void SwitchAction() {
			switch (type) {
				...
				case UndoRedoType.LayerTSChanged:
				case UndoRedoType.zMChanged:
					var ParamBTemp = ParamB;
					var ParamATemp = ParamA;
					ParamA = ParamBTemp;
					ParamB = ParamATemp;
					break;
				case UndoRedoType.ItemFlipped:
